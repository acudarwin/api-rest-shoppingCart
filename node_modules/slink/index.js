    ...
    walkDirTree(packageLinkDir, function(dir) {
        ...
        if (linkFiles) {
            for (var i = 0; i < linkFiles.length; i++) {
                ...
                } else if (!isFileOfInterest(localFilePath, packageLinkDir, filesSpec)) {
                    continue;
                }
                ...
                if (localFileStat === undefined || linkFileStat.mtime.getTime() > localFileStat.mtime.getTime()) {
                    if (linkFile !== 'package.json') {
                        ...
                        console.log('*** Looks like the package.json file in the linked package has changed. %s is more recent than %s (installed in local node_modules). Please reinstall and reslink.', linkFileStat.mtime, localFileStat.mtime);
                        process.exit(0);
                    }
                }
            }
